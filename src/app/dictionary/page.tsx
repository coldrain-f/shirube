...
import { getDictionaryEntries, getDictionaries } from '@/app/actions/dictionary'
import DictionaryClientView from './client-view'

export default async function DictionaryPage() {
  const [entries, dictionaries] = await Promise.all([
  ...
  return (
    <div className="h-full w-full p-6 bg-background overflow-y-auto">
      <div className="space-y-6">
        ...
        <DictionaryClientView initialEntries={entries} dictionaries={dictionaries} />
      </div>
    </div>
  )
}
